...
```{r error = FALSE, warning = FALSE, fig.width = 12}
result <- getCNVgenes(cnv_data, show_piechart = TRUE)
...
```{r error = FALSE, warning = FALSE, fig.width = 12}
dwc_result <- plotDiseaseCloud(gene_disease_assoc)
...
```{r error = FALSE, warning = FALSE, fig.width = 12}
dwc2_result <- plotDiseaseCloud(gene_disease_assoc, remove_most_freq = 1)
...
```{r error = FALSE, warning = FALSE, fig.width = 12}
gwc_result <- plotGeneCloud(gene_disease_assoc)
