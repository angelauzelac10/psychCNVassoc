...
The package also contains an example CNV call dataset named example_CNV_call. Refer to package vignettes for more details. An overview of the package is illustrated below. 
